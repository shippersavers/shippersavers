...
var _user$project$Layout$ButtonSearch = {ctor: 'ButtonSearch'};
var _user$project$Layout$Subtitle = {ctor: 'Subtitle'};
var _user$project$Layout$Title = {ctor: 'Title'};
var _user$project$Layout$Clean = {ctor: 'Clean'};
var _user$project$Layout$stylesheet = _mdgriffith$style_elements$Style$styleSheet(
	{
		ctor: '::',
		_0: A2(
			_mdgriffith$style_elements$Style$style,
			_user$project$Layout$Clean,
			{ctor: '[]'}),
		_1: {
			ctor: '::',
			_0: A2(
				_mdgriffith$style_elements$Style$style,
				_user$project$Layout$Title,
				{
					ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						_mdgriffith$style_elements$Style$style,
						_user$project$Layout$SearchForm,
						{
							ctor: '::',
					...
					_1: {
						...
						_0: A2(
							_mdgriffith$style_elements$Style$style,
							_user$project$Layout$TextSearch,
							{
								ctor: '::',
								_0: _mdgriffith$style_elements$Style_Font$size(24),
								_1: {
						...
						_1: {
							...
							_0: A2(
								_mdgriffith$style_elements$Style$style,
								_user$project$Layout$ButtonSearch,
								{
									ctor: '::',
							...
							_1: {
								...
								_0: A2(
									_mdgriffith$style_elements$Style$style,
									_user$project$Layout$MainContent,
									{
										ctor: '::',
...
var _user$project$Main$searchFormView = A3(
	...
	{
		ctor: '::',
		_0: A2(_mdgriffith$style_elements$Element_Attributes$paddingXY, 50, 20),
		_1: {
			ctor: '::',
	...
	},
	{
		...
		_0: A3(
			...
			},
			{
				...
				value: 'test',
				label: _mdgriffith$style_elements$Element_Input$hiddenLabel(''),
				options: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		_user$project$Layout$stylesheet,
		A3(
			_mdgriffith$style_elements$Element$column,
			_user$project$Layout$Clean,
			{ctor: '[]'},
					...
					A3(
						...
						},
						{
							...
							_0: A3(
								...
								{
									ctor: '::',
									_0: A2(_mdgriffith$style_elements$Element_Attributes$paddingXY, 0, 30),
									_1: {ctor: '[]'}
								},
								_mdgriffith$style_elements$Element$text('Shipper Savers ')),
							_1: {
								ctor: '::',
								_0: A3(
									_mdgriffith$style_elements$Element$h3,
									_user$project$Layout$Subtitle,
									{
										ctor: '::',
										_0: A2(_mdgriffith$style_elements$Element_Attributes$paddingXY, 0, 20),
										_1: {ctor: '[]'}
									},
									_mdgriffith$style_elements$Element$text('We compare sea freight from shipping lines and help save money')),
								_1: {
									ctor: '::',
